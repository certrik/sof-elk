...
DATA_INDEXES="artifact aws azure evtxlogs filefolderaccess filesystem gcp httpdlog lnkfiles logstash logstash-firewall logstash-ids logstash-sflow logstash-switch logstash-windows netflow office365 plaso zeek"
